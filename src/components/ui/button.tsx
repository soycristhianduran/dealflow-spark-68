...
const buttonVariants = cva(
  // Micro-interaction: subtle press scale + smooth color transition on hover.
  // The `active:scale-[0.97]` gives the button a tactile feel without
  // distracting motion.
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-150 active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 disabled:active:scale-100 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        // Primary buttons get a soft shadow that intensifies on hover —
        // makes the action feel "lifted" toward the user.
        default:
        ...
        // AI/premium accent — purple, used for AI features like Lead Scoring
