        ...
        <Sheet open={open} onOpenChange={setOpen}>
          ...
          <SheetContent side="left" className="w-72 p-0">
            ...
            <div className="p-2 space-y-0.5">
              <button onClick={() => handleNav("/settings")} className="flex w-full items-center gap-3 rounded-md px-3 py-2.5 text-sm font-medium text-foreground transition-colors hover:bg-accent">
                <User className="h-4 w-4 text-muted-foreground" /> Mi perfil
              </button>
              <button onClick={() => handleNav("/settings")} className="flex w-full items-center gap-3 rounded-md px-3 py-2.5 text-sm font-medium text-foreground transition-colors hover:bg-accent">
                <Settings className="h-4 w-4 text-muted-foreground" /> Configuración
              </button>
              <button onClick={() => setTheme(resolvedTheme === "dark" ? "light" : "dark")} className="flex w-full items-center gap-3 rounded-md px-3 py-2.5 text-sm font-medium text-foreground transition-colors hover:bg-accent">
                {resolvedTheme === "dark" ? <Sun className="h-4 w-4 text-muted-foreground" /> : <Moon className="h-4 w-4 text-muted-foreground" />}
            ...
            <div className="p-4">
              ...
              <div className="space-y-2">
                {mockNotifications.slice(0, 2).map(n => (
                  <button key={n.id} onClick={() => handleNav(n.link)} className="flex w-full items-start gap-2 rounded-md bg-accent/50 p-2.5 text-left hover:bg-accent transition-colors">
            ...
            <div className="mt-auto border-t p-2">
              <button onClick={() => { signOut(); setOpen(false); }} className="flex w-full items-center gap-3 rounded-md px-3 py-2.5 text-sm font-medium text-destructive transition-colors hover:bg-destructive/10">
